...
const SAMPLE_QUESTIONS = [
  ...
  {id:'int_169',subject:'internal',system:'cardiovascular',chapter:'心肌病',type:'matching',title:'心肌病特征匹配',description:'将下列临床表现和病理特征与对应的疾病进行匹配',options:[{id:'A',text:'常染色体显性遗传'},{id:'B',text:'病毒感染致免疫介导的心肌损害、遗传等'},{id:'C',text:'各心腔可扩大，左室扩大最早最显著'},{id:'D',text:'心室明显不对称肥厚，尤其室间隔肥厚(≥15mm)'},{id:'E',text:'左室流出道梗阻、心室腔变小'},{id:'F',text:'心室壁变薄，心内膜增厚'},{id:'G',text:'主动脉瓣下心内膜增厚'},{id:'H',text:'心肌收缩能力减弱、室壁运动普遍减弱(特征)'},{id:'I',text:'主要导致舒张性心衰'},{id:'J',text:'导致收缩性心衰(超声LVEF<40%)'},{id:'K',text:'伴快速房颤可用强心苷'},{id:'L',text:'劳力性呼吸困难(最常见)、胸痛、运动低血压、晕厥'},{id:'M',text:'左心衰(肺淤血水肿)或全心衰'},{id:'N',text:'心尖收缩期杂音'},{id:'O',text:'心尖或胸骨左缘4-5肋间收缩期杂音'},{id:'P',text:'胸骨左缘3-4肋间收缩期杂音，常喷射样'},{id:'Q',text:'首选β-R拮抗剂'},{id:'R',text:'超声心动图：首选和金标准'},{id:'S',text:'是青年运动猝死最常见的原因'},{id:'T',text:'SAM征：收缩期二尖瓣前叶向前移动与室间隔接触'}],categories:[{id:'C1',label:'肥厚型心肌病'},{id:'C2',label:'扩张型心肌病'},{id:'C3',label:'限制型心肌病'}],answer:{'A':'C1','D':'C1','E':'C1','I':'C1','L':'C1','O':'C1','P':'C1','Q':'C1','R':'C1','S':'C1','T':'C1','K':'C1','B':'C2','C':'C2','H':'C2','J':'C2','M':'C2','N':'C2','F':'C3','G':'C3'},explanation:'肥厚型：常染色体显性遗传/不对称肥厚/SAM征/首选β阻滞剂/青年猝死最常见；扩张型：心腔扩大/室壁运动弥漫减弱/收缩性心衰；限制型：心内膜纤维化。'},
  {id:'int_170',subject:'internal',system:'cardiovascular',chapter:'心包炎',type:'matching',title:'限制型心肌病与缩窄性心包炎鉴别',description:'将下列特征与对应的疾病进行匹配',options:[{id:'A',text:'病因：淀粉样变等'},{id:'B',text:'心包粘连增厚、钙化'},{id:'C',text:'无奇脉'},{id:'D',text:'病因结核、急性非特异性心包炎等'},{id:'E',text:'体循环回流障碍，心界不大或稍大，舒张性心衰'},{id:'F',text:'心内膜及心内膜下心肌纤维化'},{id:'G',text:'可有奇脉、心包叩击音(特点)、负性心尖搏动、室间隔抖动征'},{id:'H',text:'超声心动图：首选，金标准'}],categories:[{id:'C1',label:'限制型心肌病'},{id:'C2',label:'缩窄性心包炎'}],answer:{'A':'C1','C':'C1','E':'C1','F':'C1','B':'C2','D':'C2','G':'C2','H':'C2'},explanation:'限制型心肌病：淀粉样变/无奇脉/心内膜纤维化；缩窄性心包炎：心包钙化/奇脉/心包叩击音/室间隔抖动征。'},
  {id:'int_171',subject:'internal',system:'cardiovascular',chapter:'心包炎',type:'matching',title:'心包摩擦音与胸膜摩擦音鉴别',description:'将下列特征与对应的摩擦音类型进行匹配',options:[{id:'A',text:'摩擦音屏气后仍有'},{id:'B',text:'出现时机与呼吸一致(频率慢)'},{id:'C',text:'坐位前倾、胸骨左缘3-4肋间听诊最明显'},{id:'D',text:'积液量增多时摩擦音可消失'},{id:'E',text:'粗糙抓/搔刮音'},{id:'F',text:'摩擦音屏气后消失'},{id:'G',text:'出现时机与心搏一致(频率快)，双相或三相'},{id:'H',text:'前下侧胸壁吸气末或呼气初听诊最明显'}],categories:[{id:'C1',label:'心包摩擦音-心包炎'},{id:'C2',label:'胸膜摩擦音-胸膜炎'}],answer:{'A':'C1','C':'C1','D':'C1','G':'C1','B':'C2','E':'C2','F':'C2','H':'C2'},explanation:'心包摩擦音屏气不消失与心搏一致胸骨左缘3-4肋间最明显；胸膜摩擦音屏气后消失与呼吸一致前下侧胸壁最明显。'},
  {id:'int_172',subject:'internal',system:'cardiovascular',chapter:'心包炎',type:'matching',title:'不同类型心包炎特征对比',description:'将下列特征与对应的心包炎类型进行匹配',options:[{id:'A',text:'可伴原发结核灶'},{id:'B',text:'有原发感染灶'},{id:'C',text:'手术、心梗史'},{id:'D',text:'前驱感染1-3周'},{id:'E',text:'转移性肿瘤'},{id:'F',text:'起病急'},{id:'G',text:'起病缓'},{id:'I',text:'低热多见'},{id:'J',text:'明显化脓性'},{id:'K',text:'高热多见'},{id:'L',text:'无或低热'},{id:'M',text:'胸痛明显'},{id:'N',text:'常无胸痛'},{id:'O',text:'常有胸痛'},{id:'P',text:'心包摩擦音明显'},{id:'Q',text:'心包摩擦音不明显'},{id:'R',text:'心包积液量少'},{id:'S',text:'心包积液量大'},{id:'T',text:'血性积液'},{id:'U',text:'中性粒细胞'},{id:'V',text:'草黄色'},{id:'W',text:'淋巴细胞'}],categories:[{id:'C1',label:'结核性'},{id:'C2',label:'化脓性'},{id:'C3',label:'急性非特异性'},{id:'C4',label:'心脏损伤后综合征'}],answer:{'A':'C1','G':'C1','I':'C3','N':'C1','Q':'C1','S':'C1','T':'C1','W':'C1','B':'C2','J':'C2','K':'C2','U':'C2','D':'C3','F':'C4','M':'C3','P':'C4','R':'C3','V':'C3','C':'C4','L':'C4','O':'C4'},explanation:'结核性：起病缓/低热/血性/淋巴细胞；化脓性：高热/中性粒细胞/大量积液；急性非特异性：前驱感染/胸痛明显/摩擦音明显；心脏损伤后综合征：手术心梗史/低热。'},
  ...
  {id:'int_174',subject:'internal',system:'cardiovascular',chapter:'感染性心内膜炎',type:'matching',title:'感染性心内膜炎周围体征定义匹配',description:'将下列体征描述与对应的体征名称进行匹配',options:[{id:'A',text:'指/趾垫的红紫色痛性结节'},{id:'B',text:'手掌/足底的无痛性出血红斑'},{id:'C',text:'视网膜的中心呈白色的卵圆形出血斑'}],categories:[{id:'C1',label:'Osler结'},{id:'C2',label:'Janeway损害'},{id:'C3',label:'Roth斑'}],answer:{'A':'C1','B':'C2','C':'C3'},explanation:'Osler结：指趾垫痛性结节；Janeway损害：手掌足底无痛性出血斑；Roth斑：视网膜白色中心出血斑。'},
  {id:'int_175',subject:'internal',system:'cardiovascular',chapter:'感染性心内膜炎',type:'matching',title:'急性与亚急性感染性心内膜炎对比',description:'将下列特征与对应的感染性心内膜炎类型进行匹配',options:[{id:'A',text:'发病率少见'},{id:'B',text:'常见草绿色链球菌等毒力较弱'},{id:'C',text:'正常心瓣膜即可侵犯'},{id:'D',text:'易脱落形成栓子导致败血症/感染性梗死'},{id:'E',text:'血白细胞多正常'},{id:'F',text:'寒战高热'},{id:'G',text:'拔牙可导致'},{id:'H',text:'心脏杂音强度和性质较稳定'},{id:'I',text:'发病率多见'},{id:'J',text:'金葡菌等毒力较强'},{id:'K',text:'侵犯病变心瓣膜(如风湿病)'},{id:'L',text:'赘生物脱落主要导致体循环动脉栓塞'},{id:'M',text:'易脱落形成栓子导致无菌性梗死'},{id:'N',text:'血白细胞↑'},{id:'O',text:'发热多<39度、持续发热'},{id:'P',text:'脱落也可致肺栓塞'},{id:'Q',text:'心脏杂音强度和性质易变化或出现新的杂音'},{id:'R',text:'青霉素等治疗'},{id:'S',text:'苯唑西林或头孢唑林等治疗'}],categories:[{id:'C1',label:'急性感染性心内膜炎'},{id:'C2',label:'亚急性感染性心内膜炎'}],answer:{'A':'C1','C':'C1','D':'C1','F':'C1','J':'C1','L':'C1','N':'C1','Q':'C1','S':'C1','B':'C2','G':'C2','H':'C2','I':'C2','K':'C2','M':'C2','E':'C2','O':'C2','P':'C2','R':'C2'},explanation:'急性：金葡菌/毒力强/正常瓣膜/寒战高热/白细胞↑/杂音易变；亚急性：草绿色链球菌/毒力弱/病变瓣膜/低热/杂音稳定。'},
  ...
  {id:'int_177',subject:'internal',system:'cardiovascular',chapter:'高血压',type:'matching',title:'动态血压监测平均值匹配',description:'将下列血压数值与对应的动态血压监测时段进行匹配',options:[{id:'A',text:'<135/85'},{id:'B',text:'<120/70'},{id:'C',text:'<130/80'}],categories:[{id:'C1',label:'24小时动态血压监测平均值'},{id:'C2',label:'白天'},{id:'C3',label:'夜间'}],answer:{'A':'C1','C':'C2','B':'C3'},explanation:'24小时平均值<135/85；白天<130/80；夜间<120/70。'},
  {id:'int_178',subject:'internal',system:'cardiovascular',chapter:'高血压',type:'matching',title:'高血压急症与亚急症匹配',description:'将下列特征与高血压急症或亚急症进行匹配',options:[{id:'A',text:'血压突然↑收缩压180、或舒张压120'},{id:'B',text:'伴靶器官损害如心、脑、肾'},{id:'C',text:'不伴靶器官损害'},{id:'D',text:'血压高低与急性靶器官损害的程度并非成正比'}],categories:[{id:'C1',label:'高血压急症'},{id:'C2',label:'高血压亚急症'}],answer:{'A':'C1','B':'C1','D':'C1','C':'C2'},explanation:'高血压急症伴靶器官损害，亚急症不伴。血压高低与靶器官损害程度非成正比。'},
  {id:'int_179',subject:'internal',system:'cardiovascular',chapter:'高血压',type:'matching',title:'高血压急症降压策略与药物选择匹配',description:'将降压策略和药物与对应的高血压急症情况进行匹配',options:[{id:'A',text:'降至160/100'},{id:'B',text:'降至正常'},{id:'C',text:'降幅<25%'},{id:'D',text:'24-48小时逐步'},{id:'E',text:'可用尼卡地平'},{id:'F',text:'呋塞米'},{id:'G',text:'可用拉贝洛尔'},{id:'H',text:'硝酸酯类'},{id:'I',text:'静脉给硝普钠'}],categories:[{id:'C1',label:'高血压急症首选'},{id:'C2',label:'高血压急症伴急性冠脉综合征'},{id:'C3',label:'高血压急症伴急性脑血管病'},{id:'C4',label:'高血压急症伴妊娠或肾功能不全'},{id:'C5',label:'1小时内血压'},{id:'C6',label:'2-6小时内血压'}],answer:{'E':'C1','G':'C2','H':'C3','I':'C4','A':'C5','C':'C6'},explanation:'高血压急症1小时内降至160/100，2-6小时内降幅<25%；伴急性冠脉综合征用拉贝洛尔；伴脑血管病用硝酸酯类；伴妊娠/肾不全用硝普钠。'},
  ...
  {id:'int_196',subject:'internal',system:'cardiovascular',chapter:'急性心肌梗死',type:'matching',title:'STEMI与NSTEMI对比匹配',description:'将下列特征与对应的心肌梗死类型进行匹配',options:[{id:'A',text:'多支血管病变率低'},{id:'B',text:'冠脉非完全闭塞'},{id:'C',text:'冠脉内血栓以纤维素为主的混合血栓或红色血栓'},{id:'D',text:'心肌坏死标志物升高没有STEMI明显'},{id:'E',text:'典型心电图：病理Q、ST段弓背向上抬高、T波倒置'},{id:'F',text:'多支血管病变率高、侧枝循环多'},{id:'G',text:'冠脉完全闭塞'},{id:'H',text:'冠脉内血栓以血小板为主的白色血栓'},{id:'I',text:'无禁忌症可行溶栓'},{id:'J',text:'心肌坏死标志物明显增高'},{id:'K',text:'典型心电图：病理Q多无、ST段压低>0.1mV、T波倒置'}],categories:[{id:'C1',label:'NSTEMI'},{id:'C2',label:'STEMI'}],answer:{'A':'C1','B':'C1','C':'C1','D':'C1','K':'C1','F':'C2','G':'C2','H':'C2','I':'C2','J':'C2','E':'C2'},explanation:'NSTEMI：冠脉非完全闭塞/白色血栓/多支病变率低/ST压低/不可溶栓；STEMI：冠脉完全闭塞/红色血栓/ST抬高病理Q/可溶栓。'},
  {id:'int_197',subject:'internal',system:'cardiovascular',chapter:'急性心肌梗死',type:'matching',title:'心肌坏死标志物特征匹配',description:'将下列特征与对应的心肌坏死标志物进行匹配',options:[{id:'A',text:'最早升高(2小时内)'},{id:'B',text:'1-2周内诊断再发心梗'},{id:'C',text:'最晚恢复(持续1-2周)'},{id:'D',text:'敏感性最高'},{id:'E',text:'特异性最高'},{id:'F',text:'较准确反映梗死范围'},{id:'G',text:'3-4小时后升高'},{id:'H',text:'最早恢复(1-2天)'},{id:'I',text:'3-4天恢复'},{id:'J',text:'高峰提前出现(<14小时)间接判断溶栓再通'},{id:'K',text:'最有价值'}],categories:[{id:'C1',label:'肌红蛋白'},{id:'C2',label:'肌钙蛋白cTn'},{id:'C3',label:'肌酸激酶同工酶CK-MB'}],answer:{'A':'C1','H':'C1','C':'C2','D':'C2','E':'C2','K':'C2','B':'C2','G':'C3','I':'C3','F':'C3','J':'C3'},explanation:'肌红蛋白最早升高最早恢复(2h/1-2d)；cTn特异性敏感性最高持续1-2周最有价值；CK-MB 3-4h升高3-4d恢复反映梗死范围高峰提前判断溶栓再通。'},
  ...
  {id:'int_199',subject:'internal',system:'cardiovascular',chapter:'急性心肌梗死',type:'matching',title:'急性心梗并发症匹配',description:'将下列临床表现与对应的急性心梗并发症进行匹配',options:[{id:'A',text:'心尖收缩期杂音(二闭)'},{id:'B',text:'急性心脏压塞'},{id:'C',text:'胸骨左缘3-4肋间收缩期杂音'},{id:'D',text:'超声心动图反常搏动/矛盾运动、心电图ST段持续抬高'},{id:'E',text:'数周-数月出现心包炎(心包摩擦音)、胸膜炎、肺炎'},{id:'F',text:'心尖收缩中晚期喀喇音(二脱)'}],categories:[{id:'C1',label:'乳头肌功能失调/断裂'},{id:'C2',label:'心脏破裂/室间隔穿孔'},{id:'C3',label:'室壁瘤'},{id:'C4',label:'心梗后综合征(Dressler综合征)'}],answer:{'A':'C1','F':'C1','C':'C2','B':'C2','D':'C3','E':'C4'},explanation:'乳头肌功能失调：心尖收缩期杂音/喀喇音；室间隔穿孔：胸骨左缘3-4肋间杂音；室壁瘤：ST持续抬高/反常搏动；Dressler综合征：数周后心包炎胸膜炎肺炎。'},
  {id:'int_200',subject:'internal',system:'cardiovascular',chapter:'心肌梗死',type:'matching',title:'心肌梗死心电图定位匹配',description:'将以下心电图导联与对应梗死部位匹配',options:[{id:'A',text:'V3'},{id:'B',text:'avR'},{id:'C',text:'V2'},{id:'D',text:'Ⅰ导联'},{id:'E',text:'V5'},{id:'F',text:'avL'},{id:'G',text:'V6'},{id:'H',text:'V1'},{id:'I',text:'Ⅲ导联'},{id:'J',text:'avF'},{id:'K',text:'V4'},{id:'L',text:'Ⅱ导联'},{id:'M',text:'V7'}],categories:[{id:'C1',label:'前间壁'},{id:'C2',label:'心尖(局限前壁)'},{id:'C3',label:'广泛前壁'},{id:'C4',label:'前侧壁'},{id:'C5',label:'高侧壁'},{id:'C6',label:'下壁'}],answer:{'A':['C1','C2','C3'],'B':'C6','C':['C1','C3'],'D':['C4','C5'],'E':['C2','C3','C4'],'F':['C4','C5'],'G':'C4','H':['C1','C3'],'I':'C6','J':'C6','K':['C2','C3'],'L':'C6','M':'C4'},explanation:'前间壁：ACH。心尖(局限前壁)：AEK。广泛前壁：ACEHK。前侧壁：DEFGM。高侧壁：DF。下壁：IJL。'},
  ...
  {id:'int_203',subject:'internal',system:'cardiovascular',chapter:'心力衰竭',type:'matching',title:'左心衰与右心衰临床表现匹配',description:'将下列临床表现与对应的心衰类型进行匹配',options:[{id:'A',text:'消化道症状'},{id:'B',text:'咳嗽咳痰，双肺啰音'},{id:'C',text:'颈静脉怒张'},{id:'D',text:'夜间阵发性呼吸困难和端坐呼吸'},{id:'E',text:'肝颈静脉回流征'},{id:'F',text:'急性肺水肿/心源性哮喘'},{id:'G',text:'心尖多向左移位'},{id:'H',text:'肝大伴压痛'},{id:'I',text:'心尖多向左下移位'},{id:'J',text:'双下肢水肿'},{id:'K',text:'S3'},{id:'L',text:'奔马律'},{id:'M',text:'胸腹水(漏出液)'},{id:'N',text:'交替脉'}],categories:[{id:'C1',label:'左心衰'},{id:'C2',label:'右心衰'}],answer:{'B':'C1','D':'C1','F':'C1','I':'C1','K':'C1','L':'C1','N':'C1','A':'C2','C':'C2','E':'C2','G':'C2','H':'C2','J':'C2','M':'C2'},explanation:'左心衰：肺淤血(咳嗽咳痰/端坐呼吸/肺水肿)、心尖左下移位、S3、交替脉；右心衰：体循环淤血(颈静脉怒张/肝大/水肿/胸腹水)、心尖左移。'},
  {id:'int_204',subject:'internal',system:'cardiovascular',chapter:'心力衰竭',type:'matching',title:'心源性哮喘与支气管哮喘鉴别',description:'将下列特征与对应的疾病进行匹配',options:[{id:'A',text:'呼气性呼吸困难'},{id:'B',text:'混合性呼吸困难'},{id:'C',text:'多为干啰音'},{id:'D',text:'端坐呼吸'},{id:'E',text:'咳粉红色泡沫痰'},{id:'F',text:'多为湿啰音或干湿啰音共存'},{id:'G',text:'X线多无异常或双肺透亮度增加'},{id:'H',text:'X线多有多发左心扩大'},{id:'I',text:'肺门蝴蝶征'}],categories:[{id:'C1',label:'心源性哮喘'},{id:'C2',label:'严重支气管哮喘'}],answer:{'B':'C1','D':'C1','E':'C1','F':'C1','H':'C1','I':'C1','A':'C2','C':'C2','G':'C2'},explanation:'心源性哮喘：混合性呼吸困难/端坐呼吸/粉红色泡沫痰/湿啰音/X线心影扩大肺门蝴蝶征；支气管哮喘：呼气性呼吸困难/干啰音/X线透亮度增加。'},
  {id:'int_205',subject:'internal',system:'cardiovascular',chapter:'心力衰竭',type:'matching',title:'急性心衰血流动力学分类匹配',description:'将下列临床特征与对应的急性心衰血流动力学类型进行匹配',options:[{id:'A',text:'扩容'},{id:'B',text:'正性肌力药'},{id:'C',text:'血管收缩剂'},{id:'D',text:'利尿剂'},{id:'E',text:'调整口服药'},{id:'F',text:'血管扩张剂'}],categories:[{id:'C1',label:'干暖型'},{id:'C2',label:'干冷型'},{id:'C3',label:'湿暖型(最常见)'},{id:'C4',label:'湿冷型(最严重)'}],answer:{'A':'C1','C':'C2','B':'C4','E':'C3','D':'C4','F':'C4'},explanation:'干暖型扩容；干冷型血管收缩剂+正性肌力；湿暖型(最常见)利尿+扩血管+调整口服药；湿冷型(最严重)正性肌力+利尿+扩血管。'},
  ...
  {id:'int_207',subject:'internal',system:'cardiovascular',chapter:'心力衰竭',type:'matching',title:'心衰药物禁忌症综合匹配',description:'将下列禁忌情况与对应的不宜使用的药物类别进行匹配',options:[{id:'A',text:'血Cr>265'},{id:'B',text:'血钾>5'},{id:'C',text:'血管性水肿'},{id:'D',text:'急性心梗24小时内'},{id:'E',text:'急性心衰'},{id:'F',text:'NYHA IV级'},{id:'G',text:'病态窦房结综合征'},{id:'H',text:'二度II型和三度房室传导阻滞'},{id:'I',text:'预激综合征伴房颤'},{id:'J',text:'痛风'},{id:'K',text:'支气管哮喘'},{id:'L',text:'双肾动脉狭窄'},{id:'M',text:'变异性心绞痛'},{id:'N',text:'GFR<30'}],categories:[{id:'C1',label:'ACEI/ARB/ARNI不用'},{id:'C2',label:'β-R拮抗剂不用'},{id:'C3',label:'利尿剂不用'},{id:'C4',label:'SGLT-2i不用'}],answer:{'A':'C1','B':'C1','C':'C1','L':'C1','D':'C2','E':'C2','F':'C2','G':'C2','H':'C2','I':'C2','K':'C2','M':'C2','J':'C3','N':'C3'},explanation:'ACEI/ARB禁用于Cr>265/血钾>5/血管性水肿/双肾动脉狭窄；β阻滞剂禁用于急性心衰/NYHA IV/病窦/房室阻滞/哮喘/变异心绞痛/预激伴房颤；利尿剂禁用于痛风。'},
  ...
  {id:'int_219',subject:'internal',system:'cardiovascular',chapter:'心脏物理检查',type:'matching',title:'心尖搏动与心界移位匹配',description:'将下列心尖搏动特征与对应的心室增大类型进行匹配',options:[{id:'A',text:'心尖抬举样搏动'},{id:'B',text:'扩心病'},{id:'C',text:'心前区/剑突下抬举样搏动'},{id:'D',text:'二闭'},{id:'E',text:'负性心尖搏动'},{id:'F',text:'主狭'},{id:'G',text:'心前区/剑突下搏动弥散'},{id:'H',text:'心尖搏动多向左下移位'},{id:'I',text:'主闭'},{id:'J',text:'心尖搏动多向左移位'},{id:'K',text:'高血压'},{id:'L',text:'心界多向左扩大'},{id:'M',text:'心界多向左下扩大'},{id:'N',text:'二狭'}],categories:[{id:'C1',label:'左室大'},{id:'C2',label:'右室大'}],answer:{'A':'C1','B':'C1','D':'C1','F':'C1','H':'C1','I':'C1','K':'C1','M':'C1','C':'C2','E':'C2','G':'C2','J':'C2','L':'C2','N':'C2'},explanation:'左室大：心尖抬举样搏动/心尖向左下移位/心界向左下扩大（扩心病/二闭/主狭/主闭/高血压）；右室大：负性心尖搏动/心尖向左移位/心界向左扩大/剑突下搏动（二狭）。'},
  {id:'int_220',subject:'internal',system:'cardiovascular',chapter:'心脏物理检查',type:'matching',title:'奇脉与交替脉的病因匹配',description:'将下列疾病与对应的脉搏异常类型进行匹配',options:[{id:'A',text:'严重的右心衰'},{id:'B',text:'脉搏短绌'},{id:'C',text:'房颤'},{id:'D',text:'严重的心包积液/心脏压塞'},{id:'E',text:'严重的缩窄性心包炎'},{id:'F',text:'交替脉'},{id:'G',text:'甲亢'},{id:'H',text:'严重的支气管哮喘'},{id:'I',text:'搏搏强弱交替'},{id:'K',text:'严重的COPD'},{id:'L',text:'左心衰'},{id:'M',text:'超声心动图室间隔抖动征'},{id:'O',text:'严重的胸腹疾病（大量胸腔积液、张力性气胸）'}],categories:[{id:'C1',label:'奇脉'},{id:'C2',label:'交替脉'},{id:'C3',label:'脉搏短绌'}],answer:{'A':'C1','D':'C1','E':'C1','H':'C1','K':'C1','O':'C1','L':'C2','I':'C2','C':'C3','G':'C3'},explanation:'奇脉见于右心衰/心包积液/缩窄性心包炎/COPD/哮喘/大量胸腔积液等；交替脉见于左心衰；脉搏短绌见于房颤/甲亢。'},
  ...
  {id:'int_223',subject:'internal',system:'cardiovascular',chapter:'心脏瓣膜病',type:'matching',title:'心脏瓣膜病并发症与治疗匹配',description:'将下列并发症和治疗方式与对应的心脏瓣膜病进行匹配',options:[{id:'A',text:'最易左心衰、房颤、脑栓塞、感染性心内膜炎'},{id:'B',text:'最易左室肥厚、心绞痛、晕厥'},{id:'C',text:'最易左心衰、房颤、脑栓塞'},{id:'D',text:'最易感染性心内膜炎'},{id:'E',text:'有开瓣音：经皮球囊二尖瓣成形术'},{id:'F',text:'成人：置换术，若老年重度不宜TAVR'},{id:'G',text:'儿童青少年非钙化性：分离术'},{id:'H',text:'合并二闭等：置换术'},{id:'I',text:'修复术'}],categories:[{id:'C1',label:'二尖瓣狭窄'},{id:'C2',label:'主动脉瓣狭窄'},{id:'C3',label:'主动脉瓣关闭不全'},{id:'C4',label:'二尖瓣关闭不全'}],answer:{'C':'C1','E':'C1','G':'C1','B':'C2','F':'C2','A':'C3','D':'C4','H':'C4','I':'C4'},explanation:'二狭最易房颤/脑栓塞，有开瓣音行球囊成形术；主狭三联征（心绞痛/晕厥/心衰），成人行置换术；主闭最易左心衰/房颤/脑栓塞；二闭最易感染性心内膜炎，行修复术。'},
