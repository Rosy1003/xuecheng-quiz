...
const SAMPLE_QUESTIONS = [
  ...
  {id:'int_175',subject:'internal',system:'cardiovascular',chapter:'感染性心内膜炎',type:'matching',title:'急性与亚急性感染性心内膜炎对比',description:'将下列特征与对应的感染性心内膜炎类型进行匹配',options:[{id:'A',text:'发病率少见'},{id:'B',text:'常见草绿色链球菌等毒力较弱'},{id:'C',text:'正常心瓣膜即可侵犯'},{id:'D',text:'易脱落形成栓子导致败血性/感染性梗死'},{id:'E',text:'血白细胞多↑、可正常'},{id:'F',text:'寒战高热'},{id:'G',text:'拔牙可导致'},{id:'H',text:'心脏杂音强度和性质较稳定'},{id:'I',text:'发病率多见'},{id:'J',text:'金葡菌等毒力较强'},{id:'K',text:'侵犯病变心瓣膜(如风湿病)'},{id:'L',text:'赘生物(含菌)脱落主要导致体循环动脉栓塞:脑栓塞最常见、失明、急性心梗、肾梗死(肉眼血尿)'},{id:'M',text:'易脱落形成栓子导致无菌性梗死'},{id:'N',text:'血白细胞↑'},{id:'O',text:'发热多<39度、持续发热'},{id:'P',text:'脱落也可致肺栓塞(左向右分流的先天病、或右心内膜炎)'},{id:'Q',text:'心脏杂音强度和性质易变化或出现新的杂音'},{id:'R',text:'青霉素等治疗'},{id:'S',text:'苯唑西林或头孢唑林等治疗'}],categories:[{id:'C1',label:'急性感染性心内膜炎'},{id:'C2',label:'亚急性感染性心内膜炎'}],answer:{'A':'C1','C':'C1','D':'C1','F':'C1','J':'C1','L':['C1','C2'],'N':'C1','Q':'C1','S':'C1','B':'C2','G':'C2','H':'C2','I':'C2','K':'C2','M':'C2','E':'C2','O':'C2','P':['C1','C2'],'R':'C2'},explanation:'急性：金葡菌/毒力强/正常瓣膜/寒战高热/白细胞↑/杂音易变；亚急性：草绿色链球菌/毒力弱/病变瓣膜/低热/杂音稳定。L(体循环动脉栓塞)和P(肺栓塞)两型均可发生。'},
