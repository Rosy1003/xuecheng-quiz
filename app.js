...
const SAMPLE_QUESTIONS = [
  ...
  {id:'int_042',subject:'internal',system:'respiratory',chapter:'胸部体征',type:'matching',title:'肺部疾病体征鉴别（胸廓/纵隔/语颤/叩诊/呼吸音/啰音）',description:'将下列体征与对应疾病匹配',options:[{id:'A',text:'患侧饱满'},{id:'B',text:'桶状'},{id:'C',text:'患侧平坦塌陷'},{id:'D',text:'多对称，可桶状'},{id:'E',text:'对称'},{id:'F',text:'可移向健侧'},{id:'G',text:'正中'},{id:'H',text:'可移向患侧'},{id:'I',text:'患侧增强'},{id:'J',text:'双侧减弱'},{id:'K',text:'减弱或消失'},{id:'L',text:'减弱'},{id:'M',text:'积液上方增强'},{id:'N',text:'鼓音'},{id:'O',text:'实音或浊音'},{id:'P',text:'过清音'},{id:'Q',text:'减弱或消失'},{id:'R',text:'异常支气管或支气管肺泡呼吸音'},{id:'S',text:'减弱'},{id:'T',text:'积液上方：异常支气管或支气管肺泡呼吸音'},{id:'U',text:'多无啰音'},{id:'V',text:'湿啰音'},{id:'W',text:'干啰音为主'},{id:'X',text:'湿啰音为主'},{id:'Y',text:'湿啰音或干湿啰音'}],categories:[{id:'C1',label:'COPD'},{id:'C2',label:'支气管哮喘'},{id:'C3',label:'大叶性肺炎实变'},{id:'C4',label:'胸腔积液'},{id:'C5',label:'气胸'},{id:'C6',label:'肺泡性肺水肿'},{id:'C7',label:'肺不张'}],answer:{'A':['C4','C5'],'B':'C1','C':'C7','D':'C2','E':['C3','C6'],'F':['C4','C5'],'G':['C1','C2','C3','C6'],'H':'C7','I':'C3','J':['C1','C2'],'K':['C4','C5','C7'],'L':'C6','M':'C4','N':'C5','O':['C3','C4','C6','C7'],'P':['C1','C2'],'Q':['C4','C5','C7'],'R':'C3','S':['C1','C2','C6'],'T':'C4','U':['C4','C5','C7'],'V':'C3','W':'C2','X':'C6','Y':'C1'},explanation:'COPD(C1)：B桶状、G纵隔正中、J双侧语颤减弱、P过清音、S呼吸音减弱、Y湿或干湿啰音。支气管哮喘(C2)：D多对称可桶状、G纵隔正中、J双侧减弱、P过清音、S减弱、W干啰音为主。大叶性肺炎实变(C3)：E对称、G纵隔正中、I语颤增强、O浊音、R异常支气管呼吸音、V湿啰音。胸腔积液(C4)：A患侧饱满、F纵隔移向健侧、K语颤减弱、M积液上方增强、O浊音、Q呼吸音减弱、T积液上方异常呼吸音、U多无啰音。气胸(C5)：A患侧饱满、F移向健侧、K语颤减弱、N鼓音、Q呼吸音减弱、U多无啰音。肺泡性肺水肿(C6)：E对称、G纵隔正中、L语颤减弱、O浊音、S呼吸音减弱、X湿啰音为主。肺不张(C7)：C患侧平坦塌陷、H移向患侧、K语颤减弱、O浊音、Q呼吸音减弱、U多无啰音。'},
