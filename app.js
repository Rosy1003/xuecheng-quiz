...
const SAMPLE_QUESTIONS = [
  ...
  {id:'path_003',subject:'pathology',system:'digestive',chapter:'肝硬化',type:'matching',title:'肝硬化 · 临床表现分类',description:'将下列表现归类到对应的肝硬化临床综合征（注：部分机制参与多个分类，此处归入最特征性的分类）',options:[{id:'A',text:'腹水'},{id:'B',text:'白蛋白合成障碍'},{id:'C',text:'侧支循环形成'},{id:'D',text:'凝血因子合成减少'},{id:'E',text:'静水压和通透性↑'},{id:'F',text:'肝肾综合征(区别内科学)'},{id:'G',text:'胃肠瘀血和水肿'},{id:'H',text:'肝性脑病/肝昏迷'},{id:'I',text:'雌激素灭活障碍'},{id:'J',text:'肝处理胆红素障碍'},{id:'K',text:'直肠静脉曲张'},{id:'L',text:'(最早)瘀血性脾大'},{id:'M',text:'蜘蛛痣，肝掌'},{id:'N',text:'氨中毒'},{id:'O',text:'脾亢致血小板减少'},{id:'P',text:'腹壁静脉曲张'},{id:'Q',text:'脾亢'},{id:'R',text:'低蛋白血症'},{id:'S',text:'小叶结构改变致淤胆'},{id:'T',text:'食管胃底静脉曲张'},{id:'U',text:'睾丸萎缩'},{id:'V',text:'淋巴液外溢'},{id:'W',text:'血浆胶渗压降低'},{id:'X',text:'黄疸'},{id:'Z',text:'出血倾向'},{id:'①',text:'门-腔侧支循环分流'},{id:'②',text:'乳房发育'},{id:'③',text:'醛固酮和ADH灭活障碍'},{id:'④',text:'白/球蛋白↓或倒置'},{id:'⑤',text:'月经不调'},{id:'⑥',text:'有效循环血量↓'}],categories:[{id:'C1',label:'肝功能障碍临床表现'},{id:'C2',label:'门脉高压的临床表现'},{id:'C3',label:'腹水形成的机制'}],answer:{'A':'C2','B':'C1','C':'C2','D':'C1','E':'C3','F':'C1','G':'C2','H':'C1','I':'C1','J':'C1','K':'C2','L':'C2','M':'C1','N':'C1','O':'C2','P':'C2','Q':'C2','R':'C1','S':'C1','T':'C2','U':'C1','V':'C3','W':'C3','X':'C1','Z':'C1','①':'C2','②':'C1','③':'C3','④':'C1','⑤':'C1','⑥':'C3'},explanation:'肝功能障碍：合成↓(白蛋白→低蛋白血症、凝血因子→出血倾向)、灭活↓(雌激素→蜘蛛痣/肝掌/乳房发育/月经不调/睾丸萎缩)、代谢障碍(胆红素→黄疸、氨→肝性脑病)、结构改变(小叶结构改变致淤胆)、白/球倒置。门脉高压：脾大(最早)→脾亢、侧支循环(食管胃底静脉曲张、腹壁静脉曲张、直肠静脉曲张、门-腔分流)、胃肠瘀血水肿。腹水机制：门脉压↑(静水压↑)、低蛋白(胶渗压↓)、淋巴液外溢、继发性醛固酮↑和ADH↑(灭活障碍)、有效循环血量↓。注意：醛固酮/ADH灭活障碍、静水压↑、淋巴液外溢同时参与肝功能障碍和腹水机制，此处归入腹水机制(更具特异性)。'},
  ...
  {id:'path_006',subject:'pathology',system:'digestive',chapter:'慢性胃炎',type:'matching',title:'A型vs B型胃炎',description:'将以下选项归类到A型胃炎或B型胃炎',options:[{id:'A',text:'由自身免疫引起'},{id:'B',text:'胃酸分泌正常或减少'},{id:'C',text:'由Hp引起'},{id:'D',text:'好发于胃底、胃体'},{id:'E',text:'血维生素B12↓'},{id:'F',text:'血胃泌素正常'},{id:'G',text:'血维生素B12正常'},{id:'H',text:'抗壁细胞和内因子抗体阳性'},{id:'I',text:'常伴消化性溃疡'},{id:'J',text:'好发于胃窦'},{id:'K',text:'胃酸分泌明显减少或缺乏'},{id:'L',text:'血胃泌素↑'},{id:'M',text:'抗壁细胞和内因子抗体阴性'},{id:'N',text:'常伴恶性贫血'}],categories:[{id:'C1',label:'A型胃炎'},{id:'C2',label:'B型胃炎'}],answer:{'A':'C1','D':'C1','E':'C1','H':'C1','K':'C1','L':'C1','N':'C1','B':'C2','C':'C2','F':'C2','G':'C2','I':'C2','J':'C2','M':'C2'},explanation:'A型胃炎为自身免疫性，好发胃底胃体，胃酸↓、VitB12↓、胃泌素↑、抗体阳性、伴恶性贫血；B型胃炎由Hp引起，好发胃窦，胃酸正常或↓、VitB12正常、胃泌素正常、抗体阴性、常伴消化性溃疡。'},
  {id:'path_007',subject:'pathology',system:'digestive',chapter:'消化性溃疡',type:'matching',title:'胃溃疡vs十二指肠溃疡',description:'将以下选项归类到胃溃疡或十二指肠溃疡',options:[{id:'A',text:'中老年好发'},{id:'B',text:'好发部位在球部前壁'},{id:'C',text:'好发部位在胃窦小弯侧'},{id:'D',text:'青壮年好发'}],categories:[{id:'C1',label:'胃溃疡'},{id:'C2',label:'十二指肠溃疡'}],answer:{'A':'C1','C':'C1','B':'C2','D':'C2'},explanation:'胃溃疡好发于中老年，部位在胃窦小弯侧；十二指肠溃疡好发于青壮年，部位在球部前壁。'},
  ...
  {id:'path_009',subject:'pathology',system:'digestive',chapter:'大肠癌',type:'matching',title:'大肠癌的癌前病变',description:'将以下选项归类为大肠癌的癌前病变或非癌前病变。补充：腺瘤中最常见的是D(管状腺瘤)，腺瘤中易癌变的是O(线毛状腺瘤)。',options:[{id:'A',text:'家族性/遗传性腺瘤性息肉病'},{id:'B',text:'胶质瘤息肉病综合征'},{id:'C',text:'色素沉着黑斑息肉综合征'},{id:'D',text:'管状腺瘤'},{id:'E',text:'克罗恩病'},{id:'F',text:'慢性血吸虫病'},{id:'G',text:'幼年性息肉'},{id:'H',text:'增生性息肉病'},{id:'I',text:'混合型腺瘤'},{id:'J',text:'息肉状腺瘤'},{id:'K',text:'增生性息肉'},{id:'L',text:'幼年性息肉病'},{id:'M',text:'溃疡性结肠炎'},{id:'N',text:'肠息肉病合并多发性骨瘤和软组织瘤'},{id:'O',text:'线毛状腺瘤'}],categories:[{id:'C1',label:'大肠癌的癌前病变'},{id:'C2',label:'非癌前病变'}],answer:{'A':'C1','B':'C1','C':'C1','D':'C1','E':'C1','F':'C1','H':'C1','I':'C1','J':'C1','L':'C1','M':'C1','N':'C1','O':'C1','G':'C2','K':'C2'},explanation:'大肠癌癌前病变包括家族性腺瘤性息肉病、管状/绒毛状/混合型腺瘤、溃疡性结肠炎、克罗恩病、慢性血吸虫病等。幼年性息肉(G)和增生性息肉(K)一般不癌变。腺瘤中最常见为管状腺瘤(D)，最易癌变为绒毛状腺瘤(O)。'},
  ...
  {id:'path_011',subject:'pathology',system:'digestive',chapter:'大肠癌',type:'matching',title:'与大肠癌密切相关的基因分类',description:'将以下基因归类为原癌基因、抑癌基因或错配修复基因。补充：与大肠癌关系最密切的三个基因为F(APC)、B(RAS)、D(p53)；与遗传性腺瘤性息肉病相关的基因为F(APC)；与Lynch综合征相关的基因为C(MSH)。',options:[{id:'A',text:'DPC'},{id:'B',text:'RAS'},{id:'C',text:'MSH'},{id:'D',text:'p53'},{id:'E',text:'MCC'},{id:'F',text:'APC'},{id:'G',text:'C-Myc'},{id:'H',text:'DCC'},{id:'I',text:'BRAF'},{id:'J',text:'MLH'},{id:'K',text:'p16'}],categories:[{id:'C1',label:'原癌基因'},{id:'C2',label:'抑癌基因'},{id:'C3',label:'错配修复基因'}],answer:{'B':'C1','G':'C1','I':'C1','A':'C2','D':'C2','E':'C2','F':'C2','H':'C2','K':'C2','C':'C3','J':'C3'},explanation:'原癌基因包括RAS、C-Myc、BRAF；抑癌基因包括DPC、p53、MCC、APC、DCC、p16；错配修复基因包括MSH、MLH。APC与遗传性腺瘤性息肉病相关，MSH与Lynch综合征相关。'},
  ...
  {id:'int_015',subject:'internal',system:'respiratory',chapter:'支气管扩张与肺结核鉴别',type:'matching',title:'支气管扩张VS肺结核',description:'将下列特征归类为支扩或肺结核',options:[{id:'A',text:'多有咯血'},{id:'B',text:'大量脓痰'},{id:'C',text:'多长期低热'},{id:'D',text:'多不发热或高热（继发感染）'}],categories:[{id:'C1',label:'支扩'},{id:'C2',label:'肺结核'}],answer:{'A':'C2','B':'C1','D':'C1','C':'C2'},explanation:'支扩多有咯血、大量脓痰、多不发热或继发感染高热；肺结核多有咯血、长期低热。'},
  {id:'int_016',subject:'internal',system:'respiratory',chapter:'支气管扩张',type:'matching',title:'支扩VS COPD',description:'将以下特征与对应疾病匹配',options:[{id:'A',text:'多无咯血和杵状指'},{id:'B',text:'长期咳痰'},{id:'C',text:'大量脓痰'},{id:'D',text:'多有咯血和杵状指'}],categories:[{id:'C1',label:'支气管扩张'},{id:'C2',label:'COPD'}],answer:{'A':'C2','B':'C2','C':'C1','D':'C1'},explanation:'支扩：BCD。COPD：AB。'},
  ...
  {id:'int_019',subject:'internal',system:'respiratory',chapter:'肺部疾病好发部位',type:'matching',title:'肺部疾病好发部位匹配',description:'将下列好发部位与对应疾病匹配',options:[{id:'A',text:'上叶下部、下叶上部近胸膜处'},{id:'B',text:'单侧肺下叶'},{id:'C',text:'上叶尖后段'},{id:'D',text:'双肺下叶和背侧'},{id:'E',text:'左肺下叶'},{id:'F',text:'下叶'},{id:'G',text:'右肺上叶后段或下叶背段'},{id:'H',text:'双肺胸膜下、基底部'},{id:'I',text:'上叶尖后段、下叶背段和后基底段'}],categories:[{id:'C1',label:'大叶性肺炎'},{id:'C2',label:'小叶性肺炎'},{id:'C3',label:'支扩'},{id:'C4',label:'干性支扩'},{id:'C5',label:'吸入性肺脓肿仰卧位'},{id:'C6',label:'原发型肺结核'},{id:'C7',label:'继发型肺结核'},{id:'C8',label:'特发性肺间质纤维化'},{id:'C9',label:'HIV/AIDS并发肺结核'},{id:'C10',label:'肺梗死'}],answer:{'B':'C1','D':'C2','E':'C3','C':'C4','G':'C5','A':'C6','I':'C7','H':'C8','F':'C10'},explanation:'大叶性肺炎好发单侧肺下叶；原发型肺结核好发上叶下部下叶上部近胸膜处；继发型肺结核好发上叶尖后段下叶背段。'},
  ...
  {id:'int_043',subject:'internal',system:'digestive',chapter:'胃食管反流病',type:'matching',title:'胃食管反流病病因分类',description:'将下列选项按抗反流屏障障碍、食管清除作用降低、食管黏膜屏障功能降低分类',options:[{id:'A',text:'食管蠕动能力下降'},{id:'B',text:'食管裂孔疝'},{id:'C',text:'贲门失弛缓症术后'},{id:'D',text:'贲门失迟缓症'},{id:'E',text:'长期饮酒'},{id:'F',text:'胃内压增高（胃排空延迟、胃扩张等）'},{id:'G',text:'ACh'},{id:'H',text:'腹内压增高（便秘、肥胖、妊娠、腹水等）'},{id:'I',text:'高脂食物'},{id:'J',text:'治疗GERD药物'},{id:'K',text:'巧克力'},{id:'L',text:'吸烟'},{id:'M',text:'胰高血糖素'},{id:'N',text:'促胰液素'},{id:'O',text:'胃泌素'},{id:'P',text:'缩胆囊素CCK'},{id:'Q',text:'前列腺素'},{id:'R',text:'胃动素'},{id:'S',text:'血管活性肠肽VIP'},{id:'T',text:'钙拮抗剂CCB'},{id:'U',text:'干燥综合征'},{id:'V',text:'地西泮'},{id:'W',text:'刺激性食物或药物（NSAIDs）'},{id:'X',text:'硝酸甘油'},{id:'Y',text:'抗胆碱药'}],categories:[{id:'C1',label:'抗反流屏障（LES结构和/或功能障碍）'},{id:'C2',label:'食管清除作用降低'},{id:'C3',label:'食管黏膜屏障功能降低'}],answer:{'B':'C1','C':'C1','D':'C1','F':'C1','H':'C1','G':'C1','I':'C1','J':'C1','K':'C1','L':'C3','M':'C1','N':'C1','O':'C1','P':'C1','Q':'C1','S':'C1','T':'C1','V':'C1','X':'C1','Y':'C1','A':'C2','U':'C2','E':'C3','W':'C3'},explanation:'抗反流屏障障碍包括LES松弛（药物、激素、腹内压增高等）；食管清除降低见于蠕动能力下降、干燥综合征；黏膜屏障降低见于饮酒、吸烟、NSAIDs。'},
  ...
  {id:'int_045',subject:'internal',system:'digestive',chapter:'胃食管反流病',type:'matching',title:'心绞痛与胃食管反流病胸痛鉴别',description:'将下列特征归类为心绞痛或胃食管反流病',options:[{id:'A',text:'刺痛'},{id:'B',text:'绞痛'},{id:'C',text:'纵隔胸痛'},{id:'D',text:'卧位、弯腰加重，坐位站立位减轻'},{id:'E',text:'休息或硝酸甘油有可能缓解'},{id:'F',text:'向颈部、上肢、上腹部等放射'},{id:'G',text:'心电图多有异常'},{id:'H',text:'心电图多无异常'}],categories:[{id:'C1',label:'心绞痛'},{id:'C2',label:'胃食管反流病'}],answer:{'B':'C1','C':'C2','E':'C1','F':'C2','G':'C1','A':'C2','D':'C2','H':'C2'},explanation:'心绞痛为绞痛、休息或硝酸甘油可缓解、心电图多有异常；GERD胸痛为刺痛、卧位弯腰加重坐位减轻、心电图多无异常。'},
  {id:'int_046',subject:'internal',system:'digestive',chapter:'胃食管反流病',type:'matching',title:'反流性食管炎LA分级',description:'将下列内镜表现按LA-A/B/C/D分级匹配',options:[{id:'A',text:'破损融合>75%的食管周径'},{id:'B',text:'食管黏膜有破损'},{id:'C',text:'其长径<5mm'},{id:'D',text:'破损有融合'},{id:'E',text:'至少有一处长径>5mm'},{id:'F',text:'破损融合<75%的食管周径'}],categories:[{id:'C1',label:'A级'},{id:'C2',label:'B级'},{id:'C3',label:'C级'},{id:'C4',label:'D级'}],answer:{'B':'C4','C':'C1','E':'C2','D':'C4','F':'C3','A':'C4'},explanation:'A级破损长径<5mm；B级长径>5mm；C级破损有融合但<75%周径；D级融合>75%周径。'},
  {id:'int_047',subject:'internal',system:'digestive',chapter:'胃食管反流病',type:'matching',title:'GERD治疗药物分类与特点',description:'将下列药物特点按PPI、P-CAB、H2受体拮抗剂、弱碱性抗酸药、促胃肠动力药分类',options:[{id:'A',text:'首选，最佳'},{id:'B',text:'与K+竞争结合H+-K+-ATP酶'},{id:'C',text:'与H+-K+-ATP酶不可逆结合'},{id:'D',text:'疗程8-12周'},{id:'E',text:'疗程4-8周'},{id:'F',text:'适合轻、中度患者'},{id:'G',text:'酸环境稳定、不需酸激活、起效快、持续时间长、夜间作用确切、用药个体差异小和不良反应少'},{id:'H',text:'适合抑酸治疗后疼痛缓解而仍有腹胀的轻度患者'},{id:'I',text:'适合轻度患者临时缓解症状'}],categories:[{id:'C1',label:'质子泵抑制剂PPI（奥美/泮脱拉唑）'},{id:'C2',label:'钾离子竞争性酸阻滞剂P-CAB（伏诺拉生）'},{id:'C3',label:'H2受体拮抗剂（法莫/西咪替丁）'},{id:'C4',label:'弱碱性抗酸药（铝碳酸镁、磷酸铝、硫糖铝、氢氧化铝）'},{id:'C5',label:'促胃肠动力药（莫沙必利）'}],answer:{'A':'C1','C':'C1','D':'C3','B':'C2','E':'C2','G':'C2','F':'C4','I':'C4','H':'C5'},explanation:'PPI为首选、不可逆结合质子泵、疗程8-12周；P-CAB竞争性结合、起效快；H2受体拮抗剂适合轻中度；抗酸药临时缓解；促动力药适合腹胀患者。'},
  ...
  {id:'int_055',subject:'internal',system:'digestive',chapter:'消化性溃疡手术',type:'matching',title:'毕II式胃大部切除术亚型（Hoffmeister/Polya/Moynihan/Eiselsberg）',description:'将下列特征按不同术式亚型分类',options:[{id:'A',text:'部分胃断端'},{id:'B',text:'输入段对胃大弯'},{id:'C',text:'结肠后'},{id:'D',text:'输入段对胃小弯'},{id:'E',text:'结肠前'},{id:'F',text:'全部胃断端'}],categories:[{id:'C1',label:'Hoffmeister'},{id:'C2',label:'Polya'},{id:'C3',label:'Moynihan'},{id:'C4',label:'Eiselsberg'}],answer:{'A':'C4','C':'C2','D':'C4','F':'C3','B':'C3','E':'C4'},explanation:'Hoffmeister为结肠后、部分胃断端、输入段对胃小弯；Polya为结肠后、全部胃断端；Moynihan为结肠前、输入段对胃大弯、全部胃断端；Eiselsberg为结肠前、部分胃断端。'},
  ...
  {id:'int_078',subject:'internal',system:'digestive',chapter:'肝硬化并发症',type:'matching',title:'肝硬化并发症鉴别（自发性腹膜炎vs门静脉血栓形成）',description:'将下列表现按自发性腹膜炎和门静脉血栓形成分类',options:[{id:'A',text:'腹痛、腹水可迅速增加'},{id:'B',text:'感染表现（腹膜刺激征/低热）'},{id:'C',text:'脾脏短期迅速增大'},{id:'D',text:'多为血性腹水'},{id:'E',text:'性质为漏出液（SAAG≥11）'},{id:'F',text:'渗出液（SAAG<11、细胞>500且以多个核/中性粒细胞为主）'}],categories:[{id:'C1',label:'自发性腹膜炎'},{id:'C2',label:'门静脉血栓形成'}],answer:{'A':'C2','B':'C1','F':'C1','C':'C2','D':'C2','E':'C2'},explanation:'自发性腹膜炎有感染表现、腹水为渗出液（中性粒为主）；门静脉血栓形成脾脏短期增大、多为血性腹水、可为漏出液。'},
  {id:'int_079',subject:'internal',system:'digestive',chapter:'急性胰腺炎',type:'matching',title:'急性胰腺炎严重程度分级',description:'将下列临床表现与急性胰腺炎的严重程度分级进行匹配',options:[{id:'A',text:'无器官衰竭'},{id:'B',text:'无菌性胰腺坏死(CT)'},{id:'C',text:'无胰腺坏死(CT)'},{id:'D',text:'器官衰竭<48小时'},{id:'E',text:'感染性胰腺坏死(CT)'},{id:'F',text:'器官衰竭>48小时'}],categories:[{id:'C1',label:'轻症'},{id:'C2',label:'中重症'},{id:'C3',label:'重症'},{id:'C4',label:'危重'}],answer:{'A':'C1','B':'C2','C':'C1','D':'C2','E':'C3','F':'C3'},explanation:'轻症=无器官衰竭+无胰腺坏死(A+C)；中重症=无菌性坏死+器官衰竭<48h(B+D)；重症=感染性坏死或器官衰竭>48h(E/F)；危重=感染性坏死+器官衰竭>48h(E+F)'},
  ...
  {id:'int_087',subject:'internal',system:'renal',chapter:'急性肾损伤',type:'matching',title:'肾前性AKI与缺血性ATN的实验室鉴别',description:'将下列实验室指标与肾前性AKI或缺血性ATN进行匹配',options:[{id:'A',text:'尿比重<1.012'},{id:'B',text:'尿渗透压>500'},{id:'C',text:'尿钠(mmol/L)<10'},{id:'D',text:'尿肌酐/血清肌酐<20'},{id:'E',text:'血尿素氮/血清肌酐>20'},{id:'F',text:'钠排泄分数≥1%'},{id:'G',text:'肾衰指数≥1'},{id:'H',text:'尿沉渣透明管型'},{id:'I',text:'尿比重>1.018'},{id:'J',text:'尿渗透压<250'},{id:'K',text:'尿钠(mmol/L)>20'},{id:'L',text:'尿肌酐/血清肌酐>40'},{id:'M',text:'血尿素氮/血清肌酐<10~15'},{id:'N',text:'钠排泄分数<1%'},{id:'O',text:'肾衰指数<1'},{id:'P',text:'尿沉渣棕色颗粒管型'}],categories:[{id:'C1',label:'肾前性AKI'},{id:'C2',label:'缺血性ATN'}],answer:{'A':'C2','B':'C1','C':'C1','D':'C2','E':'C1','F':'C2','G':'C2','H':'C1','I':'C1','J':'C2','K':'C2','L':'C2','M':'C2','N':'C1','O':'C1','P':'C2'},explanation:'肾前性:尿比重高、尿渗透压高、尿钠低、钠排泄分数<1%、肾衰指数<1、透明管型；缺血性ATN:尿比重低、尿渗透压低、尿钠高、钠排泄分数≥1%、肾衰指数≥1、棕色颗粒管型'},
  {id:'int_088',subject:'internal',system:'renal',chapter:'慢性肾衰竭',type:'matching',title:'尿毒症毒素按分子量分类',description:'将下列物质按小分子、中分子、大分子毒素分类',options:[{id:'A',text:'核糖核酸酶'},{id:'B',text:'K+'},{id:'C',text:'甲状旁腺激素PTH'},{id:'D',text:'P'},{id:'E',text:'H+'},{id:'F',text:'溶菌酶'},{id:'G',text:'尿素氮'},{id:'H',text:'可致肾性骨营养不良'},{id:'I',text:'胍类'},{id:'J',text:'B2-微球蛋白'},{id:'K',text:'胺类'},{id:'L',text:'软组织钙化'},{id:'M',text:'酚类'},{id:'N',text:'维生素A结合蛋白'},{id:'O',text:'可致糖耐量下降(胰岛素抵抗)'},{id:'P',text:'氨甲酰化蛋白质'}],categories:[{id:'C1',label:'小分子毒素'},{id:'C2',label:'中分子毒素'},{id:'C3',label:'大分子毒素(蛋白质)'}],answer:{'A':'C3','B':'C1','C':'C2','D':'C1','E':'C1','F':'C1','G':'C1','H':'C2','I':'C1','J':'C3','K':'C1','L':'C2','M':'C1','N':'C3','O':'C2','P':'C3'},explanation:'小分子:BDEGIKM；中分子:PTH(C)、软组织钙化(L)、糖耐量下降(O)；大分子:核糖核酸酶(A)、B2-微球蛋白(J)、维生素A结合蛋白(N)、氨甲酰化蛋白质(P)'},
  ...
  {id:'int_094',subject:'internal',system:'renal',chapter:'肾小球疾病',type:'matching',title:'肾小球疾病与临床综合征的对应',description:'将下列肾小球疾病与最常表现的临床综合征进行匹配',options:[{id:'A',text:'脂性肾病'},{id:'B',text:'膜性肾病'},{id:'C',text:'急性肾炎'},{id:'D',text:'系膜增生性肾炎'},{id:'E',text:'急进性肾炎'},{id:'F',text:'系膜毛细血管性肾炎'},{id:'G',text:'慢性肾炎急性发作'},{id:'H',text:'局灶性节段性肾小球硬化'}],categories:[{id:'C1',label:'急性肾炎综合征'},{id:'C2',label:'肾病综合征'}],answer:{'A':'C2','B':'C2','C':'C1','D':'C2','E':'C1','F':'C2','G':'C1','H':'C2'},explanation:'急性肾炎综合征:CEG；肾病综合征:ABDFH'},
  ...
  {id:'int_209',subject:'internal',system:'cardiovascular',chapter:'心律失常',type:'matching',title:'心律失常分类匹配',description:'将下列心律失常归类为冲动形成异常或冲动传导异常',options:[{id:'A',text:'折返与旁路'},{id:'B',text:'异位心律'},{id:'C',text:'传导阻滞'},{id:'D',text:'窦性心律失常'},{id:'E',text:'生理性传导异常'},{id:'F',text:'逸搏'},{id:'G',text:'早搏'},{id:'H',text:'预激综合征'},{id:'I',text:'房室阻滞'},{id:'J',text:'窦房阻滞'}],categories:[{id:'C1',label:'冲动形成异常'},{id:'C2',label:'冲动传导异常'}],answer:{'B':'C1','D':'C1','F':'C1','G':'C1','A':'C2','C':'C2','E':'C2','H':'C2','I':'C2','J':'C2'},explanation:'冲动形成异常：窦性心律失常/异位心律(逸搏/早搏)；冲动传导异常：传导阻滞/生理性传导异常/折返与旁路/预激综合征。'},
  {id:'int_210',subject:'internal',system:'cardiovascular',chapter:'心律失常',type:'matching',title:'早搏心电图特征匹配',description:'将下列心电图特征与对应的早搏类型进行匹配',options:[{id:'A',text:'可见逆行P波'},{id:'B',text:'提早出现房性P波，形态与窦性P波不同'},{id:'C',text:'宽大畸形的QRS波前无P波'},{id:'D',text:'提早出现QRS波、形态与正常QRS波多一致'},{id:'E',text:'提早出现宽大畸形的QRS波(>0.12s)'},{id:'F',text:'P波后也可无QRS波(未下传)'},{id:'G',text:'逆行P波可在QRS波之前、之后或重叠'},{id:'H',text:'ST-T波呈继发性改变(T波与QRS主波方向相反)'},{id:'I',text:'PR间期≥0.12s'},{id:'J',text:'完全性代偿间歇'},{id:'K',text:'不完全性代偿间歇'}],categories:[{id:'C1',label:'房早'},{id:'C2',label:'交界早'},{id:'C3',label:'室早'}],answer:{'B':'C1','F':'C1','K':'C1','A':'C2','D':'C2','G':'C2','I':'C2','C':'C3','E':'C3','H':'C3','J':'C3'},explanation:'房早：提早房性P波/不完全代偿间歇；交界早：逆行P波/QRS形态正常/PR<0.12s；室早：宽大畸形QRS波/完全代偿间歇/继发性ST-T改变。'},
  {id:'int_211',subject:'internal',system:'cardiovascular',chapter:'心律失常',type:'matching',title:'阵发性室上速与室速鉴别',description:'将下列心电图特征与对应的心动过速类型进行匹配',options:[{id:'A',text:'突发突止'},{id:'B',text:'连续出现3个及以上的宽大畸形QRS波'},{id:'C',text:'心率多150-200次/分'},{id:'D',text:'特征：心室夺获、室性融合波'},{id:'E',text:'心律绝对规则'},{id:'F',text:'P波与QRS波无关，心房率快于心室率，心室率多100-250次/分'},{id:'G',text:'QRS波形态多正常'},{id:'H',text:'QRS波振幅与波峰呈周期性变化，QT间期延长，明显U波，心室率多200-250次/分'}],categories:[{id:'C1',label:'阵发性室上性心动过速'},{id:'C2',label:'室速'},{id:'C3',label:'尖端扭转型室速'}],answer:{'A':'C1','C':'C1','E':'C1','G':'C1','B':'C2','D':'C2','F':'C2','H':'C3'},explanation:'室上速：突发突止/心率150-200/心律绝对规则/QRS正常；室速：宽大畸形QRS/心室夺获/室性融合波；尖端扭转型室速：QT延长/U波/振幅周期性变化。'},
  {id:'int_212',subject:'internal',system:'cardiovascular',chapter:'心律失常',type:'matching',title:'房颤与房扑心电图特征匹配',description:'将下列心电图特征与对应的心律失常进行匹配',options:[{id:'A',text:'P波消失、转而形成f波(频率快、形态不一致，V1导联最明显)'},{id:'B',text:'P波消失、转而形成F波(规则的锯齿状扑动波，其间等电位线消失)'},{id:'C',text:'心房率350-600次/分'},{id:'D',text:'心房率250-350次/分'},{id:'E',text:'心律绝对不规则(RR间期绝对不等)'},{id:'F',text:'QRS波形态多正常'},{id:'G',text:'心室率、心律与下传情况有关'}],categories:[{id:'C1',label:'房颤'},{id:'C2',label:'房扑'}],answer:{'A':'C1','C':'C1','E':'C1','B':'C2','D':'C2','G':'C2','F':'C1'},explanation:'房颤：f波/心房率350-600/心律绝对不规则；房扑：F波(锯齿状)/心房率250-350/心室率与下传比例有关。'},
  ...
  {id:'int_214',subject:'internal',system:'cardiovascular',chapter:'心律失常',type:'matching',title:'房室传导阻滞特征匹配',description:'将下列心电图特征与对应的房室传导阻滞类型进行匹配',options:[{id:'A',text:'PR间期进行性延长，直到出现一次QRS波脱落'},{id:'B',text:'PR间期基本恒定，部分P波后无QRS波'},{id:'C',text:'QRS波不脱落，QRS波形态多正常'},{id:'D',text:'PR间期恒定延长>0.2s'},{id:'E',text:'可由强心苷中毒、高钾血症、急性下壁心梗、急性心肌炎引起'},{id:'F',text:'S1强度恒定减弱'},{id:'G',text:'S1强度基本恒定伴间歇性心搏脱落'},{id:'H',text:'S1强度逐渐减弱和心搏脱落'},{id:'I',text:'房室分离：PR间期不固定'},{id:'J',text:'S1强度变化不定可呈大炮音'},{id:'K',text:'心房率快于心室率'}],categories:[{id:'C1',label:'一度房室阻滞'},{id:'C2',label:'二度I型房室阻滞'},{id:'C3',label:'二度II型房室阻滞'},{id:'C4',label:'三度房室阻滞/完全性房室阻滞'}],answer:{'D':'C1','F':'C1','C':'C1','E':'C1','A':'C2','H':'C2','B':'C3','G':'C3','I':'C4','J':'C4','K':'C4'},explanation:'一度：PR>0.2s/QRS不脱落/S1恒定减弱；二度I型：PR进行性延长至QRS脱落/S1渐弱；二度II型：PR恒定/部分P波后无QRS/S1恒定伴间歇脱落；三度：房室分离/S1变化/大炮音。'},
  {id:'int_215',subject:'internal',system:'cardiovascular',chapter:'心律失常',type:'matching',title:'阵发性室上性心动过速治疗药物匹配',description:'将下列治疗策略与对应的室上速治疗情况进行匹配',options:[{id:'A',text:'腺苷'},{id:'B',text:'β-R拮抗剂'},{id:'C',text:'非二氢吡啶CCB(维拉帕米、地尔硫卓)'},{id:'D',text:'胺碘酮'},{id:'E',text:'电复律'},{id:'F',text:'普罗帕酮'},{id:'G',text:'导管消融'}],categories:[{id:'C1',label:'药物首选'},{id:'C2',label:'药物次选'},{id:'C3',label:'伴血流动力学障碍'},{id:'C4',label:'根治'}],answer:{'A':'C1','C':'C2','B':'C2','D':'C2','F':'C2','E':'C3','G':'C4'},explanation:'室上速首选腺苷；次选CCB/β阻滞剂/胺碘酮/普罗帕酮；伴血流动力学障碍用电复律；根治用导管消融。'},
  {id:'int_216',subject:'internal',system:'cardiovascular',chapter:'心律失常',type:'matching',title:'抗快速型心律失常药分类匹配',description:'将下列药物机制与对应的抗心律失常药分类进行匹配',options:[{id:'A',text:'阻断β-R、拮抗交感效应'},{id:'B',text:'阻断钾通道、明显延长动作电位时程APD及有效不应期ERP'},{id:'C',text:'阻断快钠通道'},{id:'D',text:'阻断L型慢钙通道'},{id:'E',text:'几乎不减慢0期Vmax，缩短动作电位时程'},{id:'F',text:'显著减慢0期Vmax，轻微延长动作电位时程'},{id:'G',text:'减慢0期Vmax，延长动作电位时程'},{id:'H',text:'普罗帕酮'},{id:'I',text:'胺碘酮'},{id:'J',text:'奎尼丁'},{id:'K',text:'利多卡因'},{id:'L',text:'美托洛尔'},{id:'M',text:'维拉帕米'}],categories:[{id:'C1',label:'I类-阻断快钠通道'},{id:'C2',label:'II类-β-R拮抗剂'},{id:'C3',label:'III类-阻断钾通道'},{id:'C4',label:'IV类-阻断慢钙通道'}],answer:{'C':'C1','E':'C1','F':'C1','G':'C1','H':'C1','J':'C1','K':'C1','A':'C2','L':'C2','B':'C3','I':'C3','D':'C4','M':'C4'},explanation:'I类阻断快钠通道(IA奎尼丁/IB利多卡因/IC普罗帕酮)；II类β阻滞剂(美托洛尔)；III类阻断钾通道(胺碘酮)；IV类阻断钙通道(维拉帕米)。'},
  {id:'int_217',subject:'internal',system:'cardiovascular',chapter:'心律失常',type:'matching',title:'起搏器代码匹配',description:'将下列起搏器代码特征与对应的起搏器类型进行匹配',options:[{id:'A',text:'感知的是自身心房信号'},{id:'B',text:'自身信号被感知后抑制或触发起搏器发放一次脉冲'},{id:'C',text:'起搏的是心房和心室'},{id:'D',text:'自身信号被感知后抑制起搏器发放一次脉冲'},{id:'E',text:'起搏的是心房'},{id:'F',text:'感知的是自身心室信号'},{id:'G',text:'起搏的是心室'},{id:'H',text:'感知的是自身心房和心室信号'},{id:'I',text:'窦房结功能正常'},{id:'J',text:'病态窦房结综合征'},{id:'K',text:'严重房室阻滞'},{id:'L',text:'房室传导功能正常'}],categories:[{id:'C1',label:'VDD'},{id:'C2',label:'DDD'},{id:'C3',label:'AAI'},{id:'C4',label:'VVI'}],answer:{'C':'C2','E':'C3','G':'C4','H':'C1','I':'C3','J':'C3','K':'C2','L':'C3'},explanation:'AAI：起搏感知心房，适合病窦综合征房室传导正常者；VVI：起搏感知心室；DDD：起搏感知心房和心室，适合严重房室阻滞。'},
