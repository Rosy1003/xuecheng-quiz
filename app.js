...
const SAMPLE_QUESTIONS = [
  ...
  {id:'surg_084',subject:'surgery',system:'vascular',chapter:'周围血管疾病',type:'matching',title:'动脉硬化闭塞症与血栓闭塞性脉管炎分期',description:'将下列临床表现与对应的分期匹配',options:[{id:'A',text:'静息痛/夜间痛'},{id:'B',text:'间歇性跛行、脉搏消失'},{id:'C',text:'坏疽、ABI<0.4'},{id:'D',text:'麻木发凉、ABI<0.9'}],categories:[{id:'C1',label:'Ⅰ期'},{id:'C2',label:'Ⅱ期'},{id:'C3',label:'Ⅲ期'},{id:'C4',label:'Ⅳ期'}],answer:{'D':'C1','B':'C2','A':'C3','C':'C4'},explanation:'Ⅰ期:麻木发凉、ABI<0.9；Ⅱ期:间歇性跛行、脉搏消失；Ⅲ期:静息痛/夜间痛；Ⅳ期:坏疽、ABI<0.4。'},
  {id:'surg_085',subject:'surgery',system:'vascular',chapter:'周围血管疾病',type:'matching',title:'Rutherford分级',description:'将下列临床表现与对应的Rutherford分级匹配',options:[{id:'A',text:'组织溃疡'},{id:'B',text:'轻度间歇性跛行'},{id:'C',text:'中度间歇性跛行'},{id:'D',text:'无明显症状'},{id:'E',text:'组织坏死'},{id:'F',text:'重度间歇性跛行'}],categories:[{id:'C1',label:'Grade 1'},{id:'C2',label:'Grade 2'},{id:'C3',label:'Grade 3'},{id:'C4',label:'Grade 4'},{id:'C5',label:'Grade 5'},{id:'C6',label:'Grade 6'}],answer:{'D':'C1','F':'C2','C':'C3','B':'C4','A':'C5','E':'C6'},explanation:'Grade1:无明显症状；Grade2:重度间歇性跛行；Grade3:中度间歇性跛行；Grade4:轻度间歇性跛行；Grade5:组织溃疡；Grade6:组织坏死。'},
  {id:'surg_086',subject:'surgery',system:'vascular',chapter:'周围血管疾病',type:'matching',title:'动脉硬化闭塞症vs血栓闭塞性脉管炎',description:'将下列临床特征与对应的疾病匹配',options:[{id:'A',text:'好发青中年男性'},{id:'B',text:'好发>45岁'},{id:'C',text:'累及中小动静脉'},{id:'D',text:'累及大中动脉'},{id:'E',text:'与高血压糖尿病高血脂有关'},{id:'F',text:'游走性浅静脉炎'},{id:'G',text:'与吸烟有关'},{id:'H',text:'与吸烟有关'}],categories:[{id:'C1',label:'动脉硬化闭塞症'},{id:'C2',label:'血栓闭塞性脉管炎(Buerger病)'}],answer:{'B':'C1','D':'C1','E':'C1','G':'C1','A':'C2','C':'C2','F':'C2','H':'C2'},explanation:'动脉硬化闭塞症:好发>45岁、累及大中动脉、与高血压糖尿病高血脂有关、与吸烟有关；血栓闭塞性脉管炎:好发青中年男性、累及中小动静脉、游走性浅静脉炎、与吸烟有关。'},
  ...
  {id:'surg_095',subject:'surgery',system:'urology',chapter:'泌尿系结石',type:'matching',title:'尿路结石特征',description:'将下列结石特征与对应的结石类型匹配',options:[{id:'A',text:'易碎'},{id:'B',text:'硬'},{id:'C',text:'光滑'},{id:'D',text:'蜡样'},{id:'E',text:'鹿角样'},{id:'F',text:'桑葚样'},{id:'G',text:'颗粒状'},{id:'H',text:'灰白色'},{id:'I',text:'棕褐色'},{id:'J',text:'红色'},{id:'K',text:'黄色'},{id:'L',text:'棕'},{id:'M',text:'最常见'},{id:'N',text:'酸化尿液+抗感染'},{id:'O',text:'X线高密度'},{id:'P',text:'X线不显影'}],categories:[{id:'C1',label:'草酸钙'},{id:'C2',label:'磷酸钙'},{id:'C3',label:'尿酸盐'},{id:'C4',label:'胱氨酸'}],answer:{'B':'C1','F':'C1','I':'C1','L':'C1','M':'C1','O':'C1','A':'C2','E':'C2','H':'C2','L':['C1','C2'],'O':['C1','C2'],'N':'C2','B':['C1','C3'],'C':['C3','C4'],'G':'C3','J':'C3','P':'C3','D':'C4','K':'C4','P':['C3','C4']},explanation:'草酸钙:硬、桑葚样、棕褐色、最常见、X线高密度；磷酸钙:易碎、鹿角样、灰白色、酸化尿液+抗感染、X线高密度；尿酸盐:硬、光滑、颗粒状、红色/黄色、X线不显影；胱氨酸:硬、光滑、蜡样、黄色、X线不显影。'},
  {id:'surg_096',subject:'surgery',system:'urology',chapter:'泌尿系结石',type:'matching',title:'尿路结石vs胆系结石',description:'将下列特征与对应的结石类型匹配',options:[{id:'A',text:'西北地区多见'},{id:'B',text:'与钙代谢异常有关'},{id:'C',text:'成分主要是胆固醇等'},{id:'D',text:'X线显影'},{id:'E',text:'X线部分显影'},{id:'F',text:'碎石、取石或其它'},{id:'G',text:'南方地区多见'},{id:'H',text:'与钙代谢异常无关'},{id:'I',text:'成分主要是草酸钙、磷酸钙'},{id:'J',text:'X线不显影'},{id:'K',text:'胆囊结石切胆囊、胆管结石取石或其它'}],categories:[{id:'C1',label:'尿路结石'},{id:'C2',label:'胆系结石'}],answer:{'B':'C1','F':'C1','G':'C1','I':'C1','A':'C2','C':'C2','H':'C2','K':'C2'},explanation:'尿路结石:南方地区多见、与钙代谢异常有关、成分主要是草酸钙和磷酸钙、碎石取石；胆系结石:西北地区多见、与钙代谢异常无关、成分主要是胆固醇等、胆囊结石切胆囊胆管结石取石。'},
