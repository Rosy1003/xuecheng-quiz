...
const SAMPLE_QUESTIONS = [
  ...
  {id:'int_119',subject:'internal',system:'hematology',chapter:'多发性骨髓瘤',type:'matching',title:'多发性骨髓瘤的治疗方案',description:'将下列治疗方案按是否适合移植进行分类',options:[{id:'A',text:'VD'},{id:'B',text:'MVP'},{id:'C',text:'硼替佐米'},{id:'D',text:'RD'},{id:'E',text:'美法仑/马法兰'},{id:'F',text:'来那度胺'},{id:'G',text:'泼尼松'},{id:'H',text:'地塞米松'}],categories:[{id:'C1',label:'移植候选者'},{id:'C2',label:'不适合移植者'}],answer:{'A':'C1','B':'C2','C':'C2','D':'C2','E':'C2','F':'C2','G':'C2','H':'C1'},explanation:'移植候选者:VD(A)、地塞米松(H)等；不适合移植者:MVP(B)、硼替佐米(C)、RD(D)、美法仑(E)、来那度胺(F)、泼尼松(G)等'},
